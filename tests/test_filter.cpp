...
int main(int argc, char* argv[])
{
    ...
    LogAlarmStream(1, 0, 0) << "1";
    LogAlarmStream(0, 0, 0) << "1";
    ...
    LogTraceStream(0, 0, 0);
    LogDebugStream(0, 1, 0);
    LogInfoStream(0, 2, 0);
    LogWarnStream(0, 3, 0);
    LogErrorStream(0, 4, 0);
    LogAlarmStream(0, 5, 0);
    LogFatalStream(0, 6, 0);
    ...
    SetDeviceConfig(GetDefaultLogger(), 0, 0, DEVICE_CFG_CATEGORY_EXTEND, 2);
    last_channel_write = ChannelWrite(0);
    last_device_write = DeviceWrite(0, 0);
    LogTraceStream(0, 0, 0);
    LogDebugStream(0, 1, 0);
    ...
    SetChannelConfig(GetDefaultLogger(), 0, CHANNEL_CFG_CATEGORY_EXTEND, 3);
    ...
    FNLOG_ASSERT(DeviceWrite(0, 0) - last_device_write == 0, "channel category and priority test ");
    ...
    LogTracePack(0, 0, 0, "aa:", -2.3f, "int:", 3);
    LogDebugPack(0, 0, 0, "aa:", -2.3f, "int:", 3);
    LogInfoPack(0,  0, 0, "aa:", -2.3f, "int:", 3);
    LogWarnPack(0,  0, 0, "aa:", -2.3f, "int:", 3);
    LogErrorPack(0, 0, 0, "aa:", -2.3f, "int:", 3);
    LogAlarmPack(0, 0, 0, "aa:", -2.3f, "int:", 3);
    LogFatalPack(0, 0, 0, "aa:", -2.3f, "int:", 3);
    ...
    LogInfoStream(1, 0, 0).write_hex_text("fn-log", sizeof("fn-log") - 1);
